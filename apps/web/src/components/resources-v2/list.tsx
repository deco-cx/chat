        ...
        actionsRight={
          <div className="pl-3 ml-2 border-l border-border flex items-center gap-2">
            ...
            {capabilities.hasCreate ? (
              <Button
                onClick={() => {
                  // Placeholder for create; could navigate to create form
                }}
                variant="special"
                size="sm"
              >
...
function ResourcesV2List() {
  ...
  const decopilotContextValue = useMemo(() => {
    ...
    return {
      additionalTools: tools.length > 0 ? {
...
export default ResourcesV2List;
