...
import { type Theme, type View, withDefaultViews, type Resource } from "@deco/sdk";
...
export function useCurrentTeam(): CurrentTeam & { views: View[]; resources: Resource[] } {
  const { org } = useParams();
  ...
  return {
    ...
    resources: (teamData as any)?.resources ?? [],
  };
}
